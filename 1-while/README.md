...
1. **Summation to `n`:** Let's implement the function `sum` that takes a single
   ...
   //_________________this works from here https://stackoverflow.com/questions/29549836/how-to-find-the-sum-of-all-numbers-between-1-and-n-using-javascript
function sum(n) {
  var total = 0; 
  for (var i = 1; i <= n; i++) {
    total += i; 
...
//Answer______________________________
     ...
     function factorial(n) {
     // TODO: your code here
     //create a variable to store num 
     var result = num; 
     ...
     //create a while loop
     while (num > 1) {
       num--; //decremations by 1 at each itereation 
